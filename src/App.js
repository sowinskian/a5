      ...
      <div className="App">
        ...
        <form className={classes.root} noValidate autoComplete="off">
          ...
          <div style={{ justifyContent: 'center', alignItems: 'center' }}>
            <Paper style={{ width: '60%', height: '40ch', overflow: 'auto', marginLeft: 'auto', marginRight: 'auto', backgroundColor: '#3d3d3d' }}>
              {
            ...
            <Paper style={{ width: '60%', height: '11ch', overflow: 'auto', marginLeft: 'auto', marginRight: 'auto', backgroundColor: '#3d3d3d' }}>
          ...
          <div>
            <Button style={{ backgroundColor: '#2a8cfd', color: 'white' }} onClick={() => { addMessage("left", value); setValue("") }} variant="contained">Traducir al Inglés</Button>
